				...
				<div class="modal-content">
					...
					<form class="modal-subscribe__form">
						...
						<div class="modal-subscribe__row">
							...
							<button type="button" id="but4" onclick="changeMZ('Форма: Хочу месяц бесплатно'); getAjax(document.getElementById('contname4').value, document.getElementById('contphone4').value, mazay)" class="button modal-subscribe__button" data-dismiss="modal" data-target="#modal-success" data-toggle="modal" disabled>Хочу месяц бесплатно</button>
                        </div>
					</form>
